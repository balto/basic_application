...
return array(
	...
	'components'=>array(
        ...
        */
		...
		'db'=>array(
			'connectionString' => 'mysql:host=127.0.0.1;dbname=basic_application',
			'emulatePrepare' => true,
			'username' => 'root',
			'password' => 'vargabal',
			'charset' => 'utf8',
...
*/
	...
	'params'=>array(
       'background'=>array(
           'image'=>'background_blue.jpg',  // az image könyvtár alatt kell lennie
           'color'=>'#0000ff',
	   ...
	   'extjs_app_namespace'=>'application',
	   'extjs_pager_max_per_page'=>20,
	   'extjs_combo_pager_max_per_page'=>11,
	   'extjs_appname' => 'Application',
       'languages'=>array(
	   ...
	   'failed_logins'=>array(
            'notify'=>array(
                ...
                'admin'=> array('vargabalazslaszlo@gmail.com' => 'Support Team'),   # értesítendő admin(ok)
                'email'=>array(
                    'subject-template'=> "Többszöri sikertelen bejelentkezés - %s",
                    'message-template'=> "%s (%s), vagy valaki az ő azonosítójával 5 alkalommal sikertelenül próbált a %s a rendszerbe bejelentkezni.\n",
                ),
            ),
            'inactivate'=>array(
                'count'=> 10,
                ...
                'email'=>array(
                    ...
                    'message-template'=> "%s (%s), vagy valaki az ő azonosítójával 10 alkalommal sikertelenül próbált a %s a rendszerbe bejelentkezni, ezért a rendszer letiltotta a felhasználót. \nAz újbóli aktiválásért forduljon rendszer adminisztrátorhoz.",
                ),
            ),
            'generate_password'=>array(
                'email'=>array(
                    'subject-template'=> "Új bejelentkezési jelszó a rendszerben",
                    'message-template'=> "%s (%s) felhasználó új jelszava a %s rendszerben:\n%s\n\n Ezt a jelszót az első sikeres belépés után meg kell változtatnia.",
                ),
            ),
        ),
...
*/
	   ...
	   'salt_for_hash' => 'nssofdsgdfgdUGUISD4435bkl',
